...
public class Salutation : SeedWork.Enumeration
{
	...
	public static readonly Salutation Mr = new(0, Resources.DataDictionary.Mr);
	public static readonly Salutation Ms = new(1, Resources.DataDictionary.Ms);
	public static readonly Salutation Dr = new(2, Resources.DataDictionary.Doctor);
	public static readonly Salutation Prof = new(3, Resources.DataDictionary.Professor);
